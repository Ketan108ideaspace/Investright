  ...
  <div class="row">
      ...
      <ul class="slides">
        <li>
          <div class="banner-img-wrap">
            ...
            <img src="<?php echo $template_url; ?>/images/banner-img.jpg" alt="banner - Invest Right"> </div>
        </li>
      </ul>
    </div>
    <div class="latest-news-wrap">
      <div class="latest-news-inner">
        <h3>Latest News
          <icon class="iconset icon-feed"></icon>
        </h3>
        <div class="latest-news-container alert">
          <h3>Investment Alert</h3>
          <p>DFRF Enterprises LLC, DFRF Enterprises Ltd., and Daniel Fernandez Rojo Filho</p>
          <p>January 30, 2015</p>
        </div>
        <div class="latest-news-container announcement">
          <h3>Announcement</h3>
          <p>Tax Free Savings Event British Columbia
          <p>January 8, 2015</p>
        </div>
        <div class="latest-news-container news">
          <h3>Canadian Securities Regulators</h3>
          <p>New Crowdfunding Exemptions</p>
          <p>May 17, 2015</p>
        </div>
        <div class="latest-news-container news">
          <h3>BCSC Enforcement Roundup</h3>
          <p>New Financial Issue</p>
          <p>April 21, 2015</p>
        </div>
      </div>
    </div>
