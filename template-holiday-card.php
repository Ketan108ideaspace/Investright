<?php
/*
 * Template Name: Holiday Card Template 
 */
global $template_url;
global $site_url;
$nvBodyCls = '';
...
<body <?php echo $nvBodyCls; ?>>
	<div class="orientation">
		<div class="msg-box">Please position your device in landscape mode </div>
	</div>
...
height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
	...
	<div class="container-innerpage" id="pjax-container">
		<div class="row">
			<div id="page-holiday" class="page-holiday" data-count="0" data-caught="0" data-gotcha="<?php if(!empty($_GET["try"])) { echo 0; } else { echo rand(1,3); } ?>">
				<div class="open-screen" <?php if(!empty($_GET['try'])) { echo 'style="display:none;"'; } ?>>
					<div class="screen-content">
					<h1>Take a Look<br />but Don't Get Caught!</h1>
				...
				<div class="win-screen">
					<div class="screen-content">
						...
						<p><a href="http://investright.108ideaspace.com" target="_blank"><img src="<?php echo $template_url; ?>/images/holiday-card-logo.png" alt="logo" ></a></p>
						<div class="share">
				...
				<div class="container-holiday">
					<div class="gift-box gift-box-01 clickable">
						...
						<div class="gift-item">
							<div class="gotcha">
								...
								<div class="gotcha-box">GOTCHA!<a href="javascript:void(0);" class="try-again">Try Again</a></div>
							</div>
						</div>
					</div>
					...
					<div class="gift-box gift-box-03 clickable">
						...
						<div class="gift-item">
							<div class="gotcha">
								...
								<div class="gotcha-box">REALLY?<a href="javascript:void(0);" class="try-again">Try Again</a></div>
							</div>
						</div>
					</div>
					...
					<div class="gift-box gift-box-05 clickable">
						...
						<div class="gift-item">
							<div class="gotcha">
								<a href="javascript:void(0);" class="try-again">Try Again</a><img src="<?php echo $template_url; ?>/images/seriously.png" alt="Seriously?" >
								<div class="gotcha-box">SERIOUSLY?</div>
							</div>
						</div>
					</div>
...
jQuery(document).ready(function() {});
    var count;
    var audio = new Audio('http://investright.108ideaspace.com/wp-content/themes/investright/audio/057364340-x-mas-magix-no-leads.mp3');
    ...
    function tryAgain(action) {
        ...
        jQuery(".gift-box").children(".gift-item").fadeOut();
		...
		if(action=='play') {
            ...
            setTimeout(function() {
			jQuery(".gift-box").each(function() {
				jQuery(this).removeClass("animates-box no-shakes non-clickable nobg").addClass("clickable").data('clicked', false).clearQueue();
			});
                }, 1200);
			//jQuery(".gift-box").data('clicked', false);
			jQuery("#page-holiday").data("count", 0);
			var gotcha = Math.floor(Math.random() * 3)+1
			jQuery("#page-holiday").data("gotcha", gotcha);
			jQuery("#page-holiday").data("caught", 1);
    ...
    function holidayGift() {
        ...
        jQuery(".clickable").on("click",function() {
            ...
            var totalGift = 0;
            //var clicked = true;
			count = jQuery("#page-holiday").data("count");
			count++;
			jQuery("#page-holiday").data("count", count);
            ...
            $this.queue(function() {
				...
				<?php } else { ?>
				var caught = jQuery("#page-holiday").data("caught");
				if( caught == 1) {
					var giftItemRandom = Math.floor(Math.random() * 2);
				} else {
				...
				<?php } ?>
				console.log('giftItemRandom' + giftItemRandom);
...
<?php //get_footer(); ?>
    <script src="//cdn.trackduck.com/toolbar/prod/td.js" async data-trackduck-id="584e03b2f1bca9d76ff24d7a"></script>
</body>
</html>