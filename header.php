...
<div class="row">
	...
	<ul class="header-nav inline">
		<li class="has-child"><a href="#" title="<?php echo ICL_LANGUAGE_NAME; ?>">
		<?php 
...
<nav>
	<div class="row">
		<div class="main-menu">
			<ul id="menu">
				<?php $nvCls = ""; if($pageId==215 || $pageId==6332 || $pageId==6308) {$nvCls = "active";} ?>
				...
				<a href="<?php echo get_permalink(215);?>" title="<?php _e( "Investing 101", "investright" ); ?>"><?php _e( "Investing 101", "investright" ); ?>
					<?php if(ICL_LANGUAGE_CODE=="en") { ?><img id="1" src="<?php echo $template_url; ?>/images/icon/down-arrow.png" alt="" class="mobilemenu arrow-icon"><?php } ?></a>
				...
				<?php $nvCls = ""; if($pageId==265 || $pageId==6322 || $pageId==6312) {$nvCls = "active";} ?>
				<li class="has-child smart <?php echo $nvCls; ?>"><a href="<?php echo get_permalink(265);?>" title="<?php _e( "Informed Investing", "investright" ); ?>"><?php _e( "Informed Investing", "investright" ); ?>
					<?php if(ICL_LANGUAGE_CODE=="en") { ?><img id="2" src="<?php echo $template_url; ?>/images/icon/down-arrow.png" alt="" class="mobilemenu arrow-icon"><?php } ?></a>
				<?php if(ICL_LANGUAGE_CODE=="en") { ?>
					<div class="mega-menu">
				...
				<?php $nvCls = ""; if($pageId==303 || $pageId==6301 || $pageId==6317) {$nvCls = "active";} ?>
				<li class="has-child fraud <?php echo $nvCls; ?>"><a href="<?php echo get_permalink(303)?>" title="<?php _e( "Fraud Awareness", "investright" ); ?>"><?php _e( "Fraud Awareness", "investright" ); ?>
					<?php if(ICL_LANGUAGE_CODE=="en") { ?><img id="3" src="<?php echo $template_url; ?>/images/icon/down-arrow.png" alt="" class="mobilemenu arrow-icon"><?php } ?></a>
				<?php if(ICL_LANGUAGE_CODE=="en") { ?>
					<div class="mega-menu">
						<div class="mm-group col-one">
							<?php
						...
						<div class="box-link-wrap">
							<?php
								...
								if($nvImage2[0]!="") { ?>
									<div class="blue-box"><a onclick="ga('send','event',{'eventCategory':'ReportConcern','eventAction':'click', 'eventLabel':'ReportConcernMegaMenu'})" href="<?php echo $nvLink2.' '.$nvTrgBlck2 ?>"><img src=<?php echo $nvImage2[0]; ?> alt="" /></a></div>
							<?php	}
								if($nvImage3[0]!="") { 
				...
				<?php $nvCls = ""; if($pageId==210 || $pageId==6294 || $pageId==6321) {$nvCls = "active";} ?>
				<li class="has-child resources <?php echo $nvCls; ?>"><a href="<?php echo get_permalink(210);?>" title="<?php _e( "Resources", "investright" ); ?>"><?php _e( "Resources", "investright" ); ?>
					<?php if(ICL_LANGUAGE_CODE=="en") { ?><img id="4" src="<?php echo $template_url; ?>/images/icon/down-arrow.png" alt="" class="mobilemenu arrow-icon"><?php } ?></a>
				<?php if(ICL_LANGUAGE_CODE=="en") { ?>
					<div class="mega-menu">
						<?php
				...
				<?php $nvCls = "";
				if($pageId==60 || $pageId==6289 || $pageId==6327) {$nvCls = "active";} ?>
				<li class="has-child about <?php echo $nvCls; ?>"><a href="<?php echo the_permalink(60);?>" title="<?php _e( "About", "investright" ); ?>"><?php _e( "About", "investright" ); ?>
					<?php if(ICL_LANGUAGE_CODE=="en") { ?><img id="5" src="<?php echo $template_url; ?>/images/icon/down-arrow.png" alt="" class="mobilemenu arrow-icon"><?php } ?></a>
				<?php if(ICL_LANGUAGE_CODE=="en") { ?>
				...
				if(ICL_LANGUAGE_CODE!="en") {
					$nvCls = "";
					if($pageId==6340 || $pageId==6343 || $pageId==6335) {$nvCls = "active";}
				?>
					<li class="has-child about <?php echo $nvCls; ?>"><a href="<?php echo the_permalink(6340);?>" title="<?php _e( "Contact Us", "investright" ); ?>"><?php _e( "Contact Us", "investright" ); ?></a></li>
				<?php
				}
				$header_menu = array(
					'theme_location' => 'Header_Menu',
